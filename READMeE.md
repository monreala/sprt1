...
Add reading from file and writing to database features for your domain . Use refactoring to keep code clean and low coupled.
 Use isValid() before inserting into database table. You will need to install
4. Add validation processor
5. Add Tasklet to move csv file after importing, into another folder
